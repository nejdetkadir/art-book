...
public class ArtContentProvider extends ContentProvider {
    ...
    static final String PRODIVER_NAME="com.nejdetkadirr.artbookv2.ArtContentProvider";
    static final String URL = "content://"+ PRODIVER_NAME +"/arts";
    ...
    static {
        ...
        uriMatcher.addURI(PRODIVER_NAME,"arts",ARTS);
    }
